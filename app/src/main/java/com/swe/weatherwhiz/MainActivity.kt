...
import com.swe.weatherwhiz.POJO.ModelClass
import com.swe.weatherwhiz.POJO.Wind
import com.swe.weatherwhiz.Utilities.ApiUtilities
import com.swe.weatherwhiz.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setDataOnViews(body: ModelClass?) {
        ...
        activityMainBinding.tvFeelsLike.text = "Night " + kelvinToCelsius(body.main.feels_like) + "°"
    ...
    private fun isLocationEnabled():Boolean{
        val locatinManager:LocationManager=getSystemService(Context.LOCATION_SERVICE) as LocationManager
        return locatinManager.isProviderEnabled(LocationManager.GPS_PROVIDER)||locatinManager.isProviderEnabled(
